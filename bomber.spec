...
Version  : 23.08.2
Release  : 59
URL      : https://download.kde.org/stable/release-service/23.08.2/src/bomber-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/bomber-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/bomber-23.08.2.tar.xz.sig
...
%prep
%setup -q -n bomber-23.08.2
cd %{_builddir}/bomber-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697242779
mkdir -p clr-build
pushd clr-build
