...
Version  : 19.08.0
Release  : 11
URL      : https://download.kde.org/stable/applications/19.08.0/src/bomber-19.08.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.0/src/bomber-19.08.0.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.0/src/bomber-19.08.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565889111
mkdir -p clr-build
pushd clr-build
