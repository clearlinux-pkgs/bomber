...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/bomber-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/bomber-24.05.0.tar.xz.sig
...
%setup -q -n bomber-24.05.0
cd %{_builddir}/bomber-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716516763
mkdir -p clr-build
pushd clr-build
