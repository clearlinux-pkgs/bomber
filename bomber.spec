...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/bomber-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/bomber-24.02.2.tar.xz.sig
...
%setup -q -n bomber-24.02.2
cd %{_builddir}/bomber-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713226651
mkdir -p clr-build
pushd clr-build
