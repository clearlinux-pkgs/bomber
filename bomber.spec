...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/bomber-22.08.0.tar.xz
...
%prep
%setup -q -n bomber-22.08.0
cd %{_builddir}/bomber-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661540724
mkdir -p clr-build
pushd clr-build
