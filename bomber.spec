...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/bomber-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/bomber-24.02.0.tar.xz.sig
...
%prep
%setup -q -n bomber-24.02.0
cd %{_builddir}/bomber-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710296172
mkdir -p clr-build
pushd clr-build
