...
Version  : 22.12.3
Release  : 51
URL      : https://download.kde.org/stable/release-service/22.12.3/src/bomber-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/bomber-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/bomber-22.12.3.tar.xz.sig
...
%prep
%setup -q -n bomber-22.12.3
cd %{_builddir}/bomber-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677783708
mkdir -p clr-build
pushd clr-build
