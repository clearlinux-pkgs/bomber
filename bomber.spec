...
Version  : 18.12.3
Release  : 3
URL      : https://download.kde.org/stable/applications/18.12.3/src/bomber-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/bomber-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/bomber-18.12.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1551982042
mkdir -p clr-build
pushd clr-build
