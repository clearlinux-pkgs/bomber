...
Version  : 20.08.3
Release  : 24
URL      : https://download.kde.org/stable/release-service/20.08.3/src/bomber-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/bomber-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/bomber-20.08.3.tar.xz.sig
...
%prep
%setup -q -n bomber-20.08.3
cd %{_builddir}/bomber-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604589882
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bomber-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/bomber/3219bb09c5feac9c87c4cd654e6e57fe0de4056e
cp %{_builddir}/bomber-20.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/bomber/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang bomber
