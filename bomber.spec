...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/bomber-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/bomber-24.05.1.tar.xz.sig
...
%setup -q -n bomber-24.05.1
cd %{_builddir}/bomber-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718396425
mkdir -p clr-build
pushd clr-build
