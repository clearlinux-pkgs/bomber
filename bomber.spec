...
Version  : 23.08.0
Release  : 57
URL      : https://download.kde.org/stable/release-service/23.08.0/src/bomber-23.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/bomber-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/bomber-23.08.0.tar.xz.sig
...
%prep
%setup -q -n bomber-23.08.0
cd %{_builddir}/bomber-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693002145
mkdir -p clr-build
pushd clr-build
