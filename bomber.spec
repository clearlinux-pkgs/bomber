...
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/bomber-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/bomber-23.04.1.tar.xz.sig
...
%prep
%setup -q -n bomber-23.04.1
cd %{_builddir}/bomber-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684786026
mkdir -p clr-build
pushd clr-build
