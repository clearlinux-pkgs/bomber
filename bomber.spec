...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/bomber-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/bomber-25.04.1.tar.xz.sig
...
%setup -q -n bomber-25.04.1
cd %{_builddir}/bomber-25.04.1
pushd ..
cp -a bomber-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747100502
mkdir -p clr-build
pushd clr-build
